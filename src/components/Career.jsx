...
const careerOptions = [
  ...
  },
  {
    ...
    description:
      "I was always drawn to visual designs that communicated ideas effectively.<br /><br /> So, I self-taught myself Graphic Design and did some cool branding, advertising, and digital media projects over the span of 7 years for different industries.",
    image: collage2,
